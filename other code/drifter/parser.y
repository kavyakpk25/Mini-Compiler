...
program: statements RETURN SEMI functions_optional ;
...
statement:
	...
	CONTINUE SEMI | BREAK SEMI | function_call SEMI | ID INCR SEMI | INCR ID SEMI | declaration SEMI
;
